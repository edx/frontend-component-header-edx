...
const Header = ({
  ...
  // const enterpriseCustomerBrandingConfig = {
  //   logoAltText: 'title',
  //   logoDestination: '',
  //   logo: 'https://edxuploads.s3.amazonaws.com/enterprise/branding/d1303765-90f9-4e01-9eaa-654c943fbd60/logo_66507fdd-ab5c-40dc-a849-5ecfb653027d.png',
  // };
  // const enterpriseLearnerPortalLink = {
  //   type: 'item',
  //   href: '#',
  //   content: 'Enterprise',
  // };
